...
void loop() {
  // Verify if sensore is knocked
  if (!knockedAtMillis) {
    catchKnock();  
  }

  //5 secods after the knock, the music starts  
  if (knockedAtMillis != 0 && millis() - knockedAtMillis == 5000) {
    playSound();
  }
...
void marioUnderworldTheme () {
    ...
    for (int thisNote = 0; thisNote < size; thisNote++) {
      ...
      int noteDuration = 1500 / underworld_tempo[thisNote];
